...
public class ThirdPersonOrbitCam : MonoBehaviour 
{
	...
	public Vector3 camOffset   = new Vector3(0.0f, 0.7f, -5.0f);       // Offset to relocate the camera related to the player position.
	...
	void LateUpdate()
	{
		...
		angleV += Mathf.Clamp(Input.GetAxis("Vertical"), -1,1) * verticalAimingSpeed * Time.deltaTime;
